...
GEMINI_API_KEY = "AIzaSyBYdA6TT1zOpj4M6Dm9aFkGwPaSIiHEbFU"
...
# Select voices for English and Hindi, if available
...
print("TTS voices selected -> EN:", EN_VOICE_ID, "| HI:", HI_VOICE_ID)

# Simple language detection: English vs Hindi (Devanagari or common Hindi words)
...
def process_command(command: str) -> str:
    ...
    # Detect language of this command and set TTS voice accordingly
    ...
    if ai_answer:
        # Voice is already set based on command language
        speak(ai_answer)
        return ai_answer
